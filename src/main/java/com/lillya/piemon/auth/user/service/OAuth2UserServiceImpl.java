...
import com.lillya.piemon.auth.user.model.Provider;
...
import com.lillya.piemon.utils.RandomStringGenerator;
...
public class OAuth2UserServiceImpl extends DefaultOAuth2UserService {
    ...
    @Autowired
    public OAuth2UserServiceImpl(PasswordEncoder passwordEncoder, RoleRepository roleRepository, UserDAO userDAO, JwtUtils jwtUtils) {
